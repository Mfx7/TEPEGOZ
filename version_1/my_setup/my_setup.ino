...
void loop(){
  ...
  if(error == 0){
    ...
    Serial.println(F("Move stick 'nose up'[pitch up or down] and back to center to continue"));
    check_to_continue();
  }
  ...
  if(error == 0){
    ...
    Serial.println(F("You can now calibrate the esc's"));
  }
  else{
...
void intro(){
  ...
  delay(1000);
  Serial.println(F(""));
  Serial.println(F("Tepegoz Setup Program"));
  Serial.println(F(""));
  Serial.println(F("==================================================="));
